const FoodData = [
  ...
  },
  {
    ...
    price: 99,
    desc: "A crispy vegetable patty layered with fresh lettuce, tomatoes, onions, and creamy mayo inside a soft toasted bun. A perfect quick bite for burger lovers.",
    category: "Lunch",
    rating: 4.3,
  },
  {
    ...
    price: 149,
    desc: "Juicy grilled patty topped with double layers of melted cheddar cheese, crunchy lettuce, and signature sauce served in a toasted sesame bun.",
    category: "Lunch",
    rating: 4.7,
  },
  {
    ...
    name: "French Fries",
    price: 79,
    desc: "Golden and crispy French fries sprinkled with a touch of sea salt. Served hot and perfect as a side with burgers or wraps.",
    category: "Snacks",
    rating: 4.4,
  },
  {
    ...
    price: 129,
    desc: "Tender bite-sized chicken nuggets coated in crispy breadcrumbs and fried to perfection. Served with spicy and tangy dipping sauces.",
    category: "Snacks",
    rating: 4.6,
  },
  {
    ...
    price: 139,
    desc: "Soft tortilla wrap filled with grilled chicken strips, fresh veggies, and creamy garlic sauce. A wholesome and filling option for lunch.",
    category: "Lunch",
    rating: 4.5,
  },
  {
    ...
    name: "Caesar Salad",
    price: 119,
    desc: "Fresh romaine lettuce tossed with Caesar dressing, crunchy croutons, and grated parmesan cheese. Light, healthy, and delicious.",
    category: "Dinner",
    rating: 4.2,
  },
  {
    ...
    price: 105,
    desc: "A refreshing blend of fresh strawberries, chilled milk, and natural sweeteners, topped with whipped cream. Perfect for a cool and fruity refreshment.",
    category: "Drinks",
    rating: 4.7,
  },
  {
    ...
    name: "Cold Coffee",
    price: 89,
    desc: "Chilled and frothy cold coffee blended with ice cream and a hint of cocoa. Perfect refreshment on a hot day.",
    category: "Drinks",
    rating: 4.4,
  },
  {
    ...
    price: 110,
    desc: "Warm and fudgy chocolate brownie with a gooey center, served with a scoop of vanilla ice cream for a delightful dessert experience.",
    category: "Dessert",
    rating: 4.9,
  },
  {
    id: 30,
    img: "https://images.unsplash.com/photo-1599490659213-e2b9527bd087?auto=format&fit=crop&w=800&q=80",
    name: "Cheese Garlic Bread",
    price: 120,
    desc: "Freshly baked garlic bread topped with melted mozzarella cheese and herbs. Crispy on the outside and soft on the inside, perfect as a side or snack.",
    category: "Snacks",
    rating: 4.6,
  },
];
